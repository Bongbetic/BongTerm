...
| **Phase 3** Developer UX | 🔨 **IN PROGRESS** — `[next]` = `3.E.1` file:line pattern matchers | — | §6.1 #9-14 green |
...
- [next] 3.E.1 `bongterm-devassist::patterns` matchers for Node/Python/Rust/.NET/TS

...
| **Phase 3** Developer UX | 🔨 **IN PROGRESS** — `[next]` = `3.E.2` clickable file:line spans | — | §6.1 #9-14 green |
...
- [next] 3.E.2 Clickable file:line spans (overlay only, no scrollback mutation)

...
| **Phase 3** Developer UX | 🔨 **IN PROGRESS** — `[next]` = `3.D.1` background job model + notifier port | — | §6.1 #9-14 green |
...
- [next] 3.D.1 `bongterm-devassist::jobs` background pane execution

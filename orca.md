...
| **Phase 3** Developer UX | 🔨 **IN PROGRESS** — `[next]` = `3.A.4` Claude Code not-installed fallback | — | §6.1 #9-14 green |
...
- [next] 3.A.4 "Claude Code not installed" graceful fallback UI
